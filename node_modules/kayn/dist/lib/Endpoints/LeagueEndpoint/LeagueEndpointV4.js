...
class LeagueEndpointV4 extends _LeagueSuperclass2.default {
    ...
    listPositionalRankQueues() {
        return new _Request2.default(this.config, this.serviceName, 'positional-rank-queues', _methodNames2.default.LEAGUE.GET_ALL_POSITIONAL_RANK_QUEUES_V4, 'GET', this.limiter, null, false, 4);
    }
}
